...
import cv2
from LK import reduce, expand, compute_flow_map, lucas_kanade, hornShunckFlow, optical_flow, optical_flow2
...
u1, v1 = lucas_kanade(basketball1, basketball2, 7)
u2, v2 = lucas_kanade(grove1, grove2)

#u1, v1 = optical_flow(basketball1, basketball2, 60, tau=1e-2)
#u1, v1 = hornShunckFlow(basketball1, basketball2, 20)
